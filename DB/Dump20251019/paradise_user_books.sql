...
CREATE TABLE `user_books` (
  ...
  KEY `book_id` (`book_id`),
  CONSTRAINT `user_books_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`UID`) ON DELETE CASCADE,
...
INSERT INTO `user_books` VALUES (1,1,'planned','2025-10-11 15:50:35',NULL);
